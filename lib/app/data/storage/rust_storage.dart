...
class NativeStorage {
  ...
  NativeStorage(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  NativeStorage.fromLookup(
  ...
  ffi.Pointer<ffi.Char> init_others_size(
    ffi.Pointer<ffi.Char> path,
  ) {
    return _init_others_size(
      path,
    );
  }

  late final _init_others_sizePtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Char> Function(
              ffi.Pointer<ffi.Char>)>>('init_others_size');
  late final _init_others_size = _init_others_sizePtr
      .asFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>)>();

  ffi.Pointer<ffi.Char> is_others_size_work_done() {
    return _is_others_size_work_done();
  }

  late final _is_others_size_work_donePtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function()>>(
          'is_others_size_work_done');
  late final _is_others_size_work_done = _is_others_size_work_donePtr
      .asFunction<ffi.Pointer<ffi.Char> Function()>();

  ffi.Pointer<ffi.Char> get_others_size() {
    return _get_others_size();
  }

  late final _get_others_sizePtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function()>>(
          'get_others_size');
  late final _get_others_size =
      _get_others_sizePtr.asFunction<ffi.Pointer<ffi.Char> Function()>();
}
